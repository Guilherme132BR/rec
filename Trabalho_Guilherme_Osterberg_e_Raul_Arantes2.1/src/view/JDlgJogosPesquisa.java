 ...
 * @author Guilh
 */
public class JDlgJogosPesquisa extends javax.swing.JDialog {

     private JDlgJogos jDlgJogos;
    JogosControle jogosControle;
    /**
     * Creates new form JDlgJogosPesquisa
     */
    public JDlgJogosPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        Jogos jogos = jogosControle.getBean(rowSel);
        jDlgJogos.beanView(jogos);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(JDlgJogosPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgJogosPesquisa dialog = new JDlgJogosPesquisa(new javax.swing.JFrame(), true);
